...
<img src="/images/developer-guide/evaluate/overview/evaluation-flow.svg" alt="Diamond evaluation flow showing harness, scenarios, probes, agent, detectors, and Trust Score" style={{maxWidth: '600px', margin: '2rem auto', display: 'block'}} />
