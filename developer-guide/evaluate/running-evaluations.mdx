...
3. In the **Select Harness** section, you can configure:
    - **[Trust Scores](/concepts/trust-score/introduction)** - Choose between [Security](/concepts/trust-score/security), [Reliability](/concepts/trust-score/reliability), and [Safety](/concepts/trust-score/safety), or select all.
    ...
    - **Garak** - Select Garak [Scenarios](/concepts/evaluation-components/scenario).
