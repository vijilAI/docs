...
<Info>
This reference covers the Python SDK (`from vijil import Vijil`). For interactive, natural-language access from Claude Code, see [MCP](/developer-guide/agentic/quickstart). For terminal commands, see the [CLI Reference](/developer-guide/cli/setup).
</Info>
