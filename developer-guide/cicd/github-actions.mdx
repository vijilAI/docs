...
1. Store your API Key as a repository secret (see [CI/CD Overview](/developer-guide/cicd/overview)):
   - `VIJIL_API_KEY`
...
jobs:
  evaluate:
    ...
    steps:
      ...
      - name: Run evaluation
        env:
          VIJIL_API_KEY: ${{ secrets.VIJIL_API_KEY }}
        ...
        run: |
          ...
          # Authenticate using VIJIL_API_KEY from environment
          vijil = Vijil()
...
<CardGroup cols={2}>
  <Card title="CI/CD Overview" icon="git-branch" href="/developer-guide/cicd/overview">
