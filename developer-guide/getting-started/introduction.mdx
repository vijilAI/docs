...
<CardGroup cols={1}>
  <Card title="Build & Test" icon="code">
    ...
    **Start here:**
    <ul className="card-no-bullets" style={{ paddingLeft: 0, marginTop: '0.5rem' }}>
      <li><a href="/developer-guide/getting-started/quickstart">Quickstart</a></li>
      <li><a href="/developer-guide/frameworks/langchain">Framework Guides</a></li>
    </ul>
  </Card>
  <Card title="Automate & Gate" icon="binoculars">
    ...
    **Start here:**
    <ul className="card-no-bullets" style={{ paddingLeft: 0, marginTop: '0.5rem' }}>
      <li><a href="/developer-guide/cicd/overview">CI/CD Overview</a></li>
      <li><a href="/developer-guide/cicd/github-actions">GitHub Actions</a></li>
    </ul>
  </Card>
  <Card title="Protect & Audit" icon="shield">
    ...
    **Start here:**
    <ul className="card-no-bullets" style={{ paddingLeft: 0, marginTop: '0.5rem' }}>
      <li><a href="/developer-guide/evaluate/understanding-results">Understanding Results</a></li>
