...
The quickstart uses your existing agent code with no modifications required. Vijil wraps your agent function, exposes it temporarily for evaluation, and tears down when complete.
