...
Review the [release notes](/legacy/concepts/release-notes) before upgrading for any breaking changes.

## Next Steps

<CardGroup cols={2}>
  <Card title="Configuration Reference" icon="settings-2" href="/developer-guide/enterprise/configuration">
