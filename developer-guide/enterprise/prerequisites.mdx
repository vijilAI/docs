...
- **Amazon S3**: Necessary for storing artifacts and handling data uploads for Harness creations and other funcitonality. You will need to create three S3 buckets:
  ...
  3. **File Uploads Bucket** – for handling file uploads, such as files used in [Harness](/concepts/evaluation-components/harness) creation.
...
| LLM API Key | Groq | Diamond evaluation and report generation | Customer (from Groq) |
