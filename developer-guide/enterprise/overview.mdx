...
<img src="/images/developer-guide/enterprise/overview/enterprise-architecture.svg" alt="Vijil system architecture showing Diamond, Dome, and Console components" style={{maxWidth: '700px', margin: '2rem auto', display: 'block'}} />
...
<CardGroup cols={2}>
  ...
  <Card title="Configuration" icon="settings-2" href="/developer-guide/enterprise/configuration">
