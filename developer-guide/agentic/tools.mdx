...
| Tool | Description |
|------|-------------|
| `redteam_create` | Create an Engagement |
| `redteam_list` | List Engagements |
| `redteam_status` | Get Engagement status |
| `redteam_results` | Get Engagement results |
| `redteam_cancel` | Cancel a running Engagement |
| `redteam_delete` | Delete an Engagement |
| `redteam_seeds` | List attack seeds |
| `redteam_attacks` | List attacker runs |
| `redteam_attack` | Get one attacker run |
| `redteam_judgments` | List judgments |
| `redteam_judgment` | Get one judgment |
| `redteam_reflections` | List reflections |
| `redteam_reflection` | Get one wave's reflection |
| `redteam_report` | Get the final report |
| `redteam_report_md` | Get the final report as Markdown |
| `redteam_report_pdf` | Get the final report as PDF |
...
| `attacker` | dict | Attacker behavior overrides |
...
Get the final report, with clustered vulnerabilities, policy violations, leaked artifacts, and successful strategies. Use `redteam_report_md` or `redteam_report_pdf` for a shareable rendering.
