...
**[Trust Score](/concepts/trust-score/introduction)** summarizes how an agent performs across **[reliability](/concepts/trust-score/reliability)**, **[security](/concepts/trust-score/security)**, and **[safety](/concepts/trust-score/safety)**; so reviews can reference evidence instead of opinions. Under that umbrella, **Diamond** probes behavior in depth through Trust Score evaluations and adaptive Red Team campaigns, while **Dome** enforces **[Guardrails](/concepts/defense/guardrail)** at runtime.
