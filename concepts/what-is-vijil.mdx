...
<img src="/images/vijil-lifecycle-light.svg" alt="Vijil lifecycle: Build with Depot, Ship with Diamond, Run with Dome, Evolve with Darwin" style={{maxWidth: '500px', margin: '1.5rem auto', display: 'block'}} className="theme-aware-image"/>
