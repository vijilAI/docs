...
**Attack Seed**
An adversarial goal generated from a risk taxonomy and Agent context for a Red Team evaluation. Each seed guides an attacker toward a specific failure mode.
...
**Diamond**
Vijil's evaluation platform. Behavioral evaluations use Harnesses to produce Trust Scores; Red Team evaluations use adaptive attacks to uncover vulnerabilities.
...
**Harness**
A collection of Scenarios used in a behavioral evaluation. Harnesses can target specific threat categories (like OWASP LLM Top 10) or comprehensive trust assessment.

---

**Judgment**
The assessment of one Red Team attack transcript. It records attack success, potential harm, harmful content, and leaked artifacts.
...
**Red Team**
A Diamond evaluation type that runs adaptive waves of adversarial attacks against a registered Agent to uncover vulnerabilities, policy violations, leaked artifacts, and successful attack strategies. Its output is a findings report; Trust Scores come from behavioral evaluations.

---

**Reflection**
A summary produced after a Red Team wave. It records successful seeds and new attack patterns that guide later waves.
...
**Wave**
One iteration of a Red Team evaluation. Each wave generates seeds, runs attackers, judges transcripts, and produces a reflection that guides the next wave.
