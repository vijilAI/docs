...
**Classification**
The verdict Discover records on whether a discovered Resource is an AI workload: AI, Non-AI, or Uncertain. 

---

**Collector**
The Discover software that inspects a Target and reports what it finds. The main kinds are endpoint, network scanner, in-cluster, and cloud API, alongside a browser extension and several one-shot Collectors. Many Collectors can report into one Target.
...
**Discover**
Vijil's discovery product. Finds the AI agents, models, and services running across an estate, classifies them, and makes the eligible ones registerable as Agents.
...
**Resource**
A single thing a Collector found, carrying the evidence behind its Classification and every scan that has observed it. An Agent is one Resource type; models, functions, and runtimes are others.
...
**Target**
A place you want Discover to look at: a fleet of laptops, a network, a cluster, or a cloud account. Findings group under the Target, and many Collectors can report into one.
