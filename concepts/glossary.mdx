...
**Classification**
The verdict Discover records on whether a discovered Resource is an AI workload: AI, Non-AI, or Uncertain. Every Classification carries the written reason behind it.

---

**Collector**
The Discover software that inspects a Target and reports what it finds. Four kinds exist: endpoint, network scanner, in-cluster, and cloud API. Many Collectors can report into one Target.
