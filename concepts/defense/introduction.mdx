...
<img src="/images/concepts/defense/introduction/defense-flow-light.svg" alt="Defense flow: Input through Guardrail, Guards, Detectors, then to Agent, then Output through Detectors, Guards, Guardrail" style={{maxWidth: '600px', margin: '2rem auto', display: 'block'}} />
