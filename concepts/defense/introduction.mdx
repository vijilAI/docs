...
| **What it does** | Runs behavioral evaluations with [Probes](/concepts/evaluation-components/probe) or adaptive [Red Team](/concepts/platform/diamond#red-team-in-diamond) evaluations | Intercepts inputs/outputs; blocks flagged content |
| **Output** | [Trust Score](/concepts/trust-score/introduction) for behavioral evaluations; findings and a report for Red Team evaluations | Allow / block decision + audit trace |
