...
<img src="/images/eval-flow-light.svg" alt="Evaluation flow: Harness to Scenario to Probe to Prompt, then to Agent, then Response to Detector to Pass Rate to Trust Score" style={{maxWidth: '600px', margin: '2rem auto', display: 'block'}} />
