...
description: "How Diamond structures Agent testing, from Harness and Scenario through Probe and Detector to a Trust Score."
---
...
Standard Diamond evaluations use the Harness hierarchy to run a known set of test cases and produce a Trust Score or custom evaluation report. [Red Team](/concepts/red-team/introduction) is also part of Diamond.

Use standard Evaluations when you need reproducible score evidence. Use Red Team when you need deeper adversarial exploration of security, safety, policy, and data leakage risks. A Red Team run creates an [Engagement](/concepts/red-team/engagements). To start one, see [Run a Red Team Campaign](/owner-guide/red-team/running-campaigns) for the Console flow or the [Red Team Overview](/developer-guide/red-team/overview) for programmatic access.
