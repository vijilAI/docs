...
A Scenario is a collection of [Probes](/concepts/evaluation-components/probe) that share a common purpose, they test for the same type of vulnerability, failure mode, or behavior. While a [Harness](/concepts/evaluation-components/harness) defines what you want to measure overall, Scenarios organize the specific ways you are testing for it.
