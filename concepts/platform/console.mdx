...
- [Discover the AI running in your estate](/owner-guide/discover/introduction)
...
<Card title="Register an Agent" icon="bot" href="/owner-guide/register-agents/registering-agents" cta="Start by Registering an Agent">
</Card>

<Card title="Run an Evaluation" icon="flask-conical" href="/owner-guide/run-evaluations/running-evaluations" cta="Proceed by Running an Evaluation">
</Card>

<Card title="Create a Custom Harness" icon="shield-ellipsis" href="/owner-guide/simulate-environment/custom-harnesses" cta="Further configure your evaluation environment with Custom Harnesses">
