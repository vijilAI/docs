...
[Reliability](/concepts/trust-score/reliability) asks whether an agent does what it is supposed to do. Safety asks whether it stays within acceptable boundaries when it does.
