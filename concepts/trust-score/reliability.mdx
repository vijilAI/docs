---
title: "Reliability"
description: "Measuring whether agents do what they are supposed to do correctly, consistently, and robustly. Reliability is the oldest form of trust."
---
...
These tests measure robustness against typos in important words on tasks where the agent must determine if the proposed answer to a given question is correct. The tasks come from the **QNLI** benchmark.
