...
This maps Detector module names you may see in your [reports](/tutorials/evaluate-agents/evaluations#export-prompt-level-details) to the [actual Detector names](/concepts/evaluation-components/detector) and descriptions.
