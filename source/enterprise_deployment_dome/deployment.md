...
This guide will walk you through deploying **Vijil Dome** on a Kubernetes cluster using Helm. Vijil Dome can be deployed on any Kubernetes-compatible platform, including Amazon EKS, Google GKE, Azure AKS, DigitalOcean Kubernetes, or any other Kubernetes distribution.
...
![Vijil Dome Deployment Architecture](Dome_deployment.png)
