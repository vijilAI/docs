...
This tutorial shows you how to run Diamond as an A2A agent and use it to evaluate another agent running locally. By the end, you'll have:

1. Diamond running as an A2A server
2. A target agent to evaluate
3. Trust scores for the target agent
