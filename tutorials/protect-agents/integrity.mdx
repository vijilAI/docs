---
title: "Integrity"
description: "Integrity methods evaluate query strings based on some available context to check for possible hallucinations and ungrounded or incorrect conclusions"
---

Integrity methods will typically only apply to output guards in RAG-based applications.
