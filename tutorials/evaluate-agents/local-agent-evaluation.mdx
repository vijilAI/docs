---
title: "Evaluating Agents with Custom Endpoints"
description: ""
---
...
1. [A Vijil client](/developer-guide/getting-started/quickstart). In this topic we will assume you have instantiated a Vijil client called `client`.
...
![Report generation progress](/images/tutorials/evaluate-agents/local-agent-evaluation/local_evaluation_creation.gif)
