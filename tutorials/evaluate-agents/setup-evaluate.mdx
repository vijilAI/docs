...
![Agent selection in an Evaluation](/images/tutorials/evaluate-agents/setup-evaluate/select_agents.png)
...
![Harness selection in an Evaluation](/images/tutorials/evaluate-agents/setup-evaluate/select_harness.png)
...
![Selected Agents shown](/images/tutorials/evaluate-agents/setup-evaluate/selected_agents.png)
5. Enter an Evaluation name in the `Enter a name...` field.
![Evaluation name entry](/images/tutorials/evaluate-agents/setup-evaluate/evaluation_name.png)
6. Press Create.
...
![API Token Location | 80%](/images/tutorials/evaluate-agents/setup-evaluate/token-generation.png)
