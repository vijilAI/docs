...
![Agent selection in an Evaluation](/images/select_agents.png)
...
![Harness selection in an Evaluation](/images/select_harness.png)
...
![Selected Agents shown](/images/selected_agents.png)
5. Enter an Evaluation name in the `Enter a name...` field.
![Evaluation name entry](/images/evaluation_name.png)
6. Press Create.
