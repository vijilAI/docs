...
Before doing any of this, you will need to [instantiate](/developer-guide/getting-started/quickstart) your Vijil client. In this topic we will assume you have instantiated a Vijil client called `client`.
