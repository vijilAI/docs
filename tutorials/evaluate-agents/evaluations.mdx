...
3. Select the Harnesses you want to run. See [Harnesses](/concepts/evaluation-components/harness) for more information.
...
- `harnesses`: [Harnesses](/concepts/evaluation-components/harness) determine which Probes you want to run, which determines what makes up your trust score.
