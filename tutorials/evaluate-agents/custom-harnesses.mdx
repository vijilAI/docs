...
<Tabs>
    ...
    <Tab title="Generate Prompts">
        ...
        ![Specify an Agent](/images/specify_agent.png)
        2. Specify up to 3 **Personas**.
       ![Specify a Persona](/images/specify_personas.png) 
        <Info>
        ...
        ![Specify Policy Requirements](/images/policy_requirements.png) 
        <Info>
        ...
        ![Specify Additional Tests](/images/specify_additional_tests.png)
        5. Press Create.
    </Tab>
</Tabs>
