...
description: "Create a custom Harness to evaluate your agent against your own policies and use case"
---
...
![Harness metadata](/images/tutorials/evaluate-agents/custom-harnesses/harness_meta.png)

<Tabs>
    <Tab title="Select Prompts">
        1. Select an existing prompt, or create a new one by pressing **Add Prompt**.
        ![Prompt selection](/images/tutorials/evaluate-agents/custom-harnesses/select_prompts.png)
        2. Press Create.
    </Tab>
    <Tab title="Generate Prompts">
        ...
        ![Specify an Agent](/images/tutorials/evaluate-agents/custom-harnesses/specify_agent.png)
        2. Specify up to 3 **Personas**.
       ![Specify a Persona](/images/tutorials/evaluate-agents/custom-harnesses/specify_personas.png) 
        <Info>
        ...
        ![Specify Policy Requirements](/images/tutorials/evaluate-agents/custom-harnesses/policy_requirements.png) 
        <Info>
        ...
        ![Specify Additional Tests](/images/tutorials/evaluate-agents/custom-harnesses/specify_additional_tests.png)
        5. Press Create.
    </Tab>
</Tabs>
...
The following example assumes that you have already initialized a Vijil [client](/developer-guide/getting-started/quickstart) named `client`.
