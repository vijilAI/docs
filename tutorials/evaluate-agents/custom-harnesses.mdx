...
![Harness metadata](/images/tutorials/evaluate-agents/custom-harnesses/harness_meta.webp)

<Tabs>
    <Tab title="Select Prompts">
        1. Select an existing prompt, or create a new one by pressing **Add Prompt**.
        ![Prompt selection](/images/tutorials/evaluate-agents/custom-harnesses/select_prompts.webp)
        2. Press Create.
    </Tab>
    <Tab title="Generate Prompts">
        ...
        ![Specify an Agent](/images/tutorials/evaluate-agents/custom-harnesses/specify_agent.webp)
        2. Specify up to 3 **Personas**.
       ![Specify a Persona](/images/tutorials/evaluate-agents/custom-harnesses/specify_personas.webp) 
        <Info>
        ...
        ![Specify Policy Requirements](/images/tutorials/evaluate-agents/custom-harnesses/policy_requirements.webp) 
        <Info>
        ...
        ![Specify Additional Tests](/images/tutorials/evaluate-agents/custom-harnesses/specify_additional_tests.webp)
        5. Press Create.
    </Tab>
</Tabs>
...
Once the Harness is created, you can [run an evaluation](/tutorials/evaluate-agents/evaluations#create-an-evaluation) with it:
