...
description: "Learn how to evaluate the Gemini series of LLMs, available through APIs in Google Vertex AI, using Vijil Evaluate"
---
...
![Setting up a Google Cloud-based Agent in Vjil](/images/manage-agents/integrations/vertex/gcp.webp)
