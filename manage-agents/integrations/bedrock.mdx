---
title: "AWS Bedrock/Bedrock Agents"
description: "Evaluate LLMs or agents, accessed as RESTful APIs on Amazon Bedrock, using Vijil Evaluate"
---
...
<Tabs>
  <Tab title="AWS Bedrock">
    ![Setting up an AWS-based Agent in Vjil](/images/manage-agents/integrations/bedrock/aws.webp)
    - Enter a model name (for example `us.amazon.nova-lite-v1:0` for foundation models).
  </Tab>
  <Tab title="AWS Bedrock Agents">
    ![Setting up an AWS Bedrock Agents-based Agent in Vjil](/images/manage-agents/integrations/bedrock/aws_agents.webp)
    - Enter an **Agent ID**.
