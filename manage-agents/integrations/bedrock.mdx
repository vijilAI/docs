...
<Tabs>
  <Tab title="AWS Bedrock">
    ![Setting up an AWS-based Agent in Vjil](/images/manage-agents/integrations/bedrock/aws.png)
    - Enter a model name (for example `us.amazon.nova-lite-v1:0` for foundation models).
  </Tab>
  <Tab title="AWS Bedrock Agents">
    ![Setting up an AWS Bedrock Agents-based Agent in Vjil](/images/manage-agents/integrations/bedrock/aws_agents.png)
    - Enter an **Agent ID**.
