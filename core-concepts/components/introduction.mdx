...
![Vijil Evaluation components](/images/core-concepts/components/introduction/Harness-scenario-probe-detector.webp)
...
<Columns cols={2}>
    ...
    <Card
        ...
        href="/core-concepts/components/guard"
        arrow="true"
    >
    ...
    <Card
        ...
        horizontal
        icon="train-track"
        href="/core-concepts/components/guardrail"
        arrow="true"
    >
