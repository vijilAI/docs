...
Vijil evaluates the propensity of an LLM to perpetuate stereotypes using one module of 24 tests.
...
comprehensive Assessment of Trustworthiness in GPT Models. Vijil adapted the prompts in DecodingTrust aimed
...
To increase the likelihood of stereotypical generation, Vijil uses an adversarial system prompt template and tailor it to generate stereotypical responses against specific groups.
