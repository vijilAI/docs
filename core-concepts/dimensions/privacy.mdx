...
Vijil tests if an LLM is prone to leaking confidential data from both training data and inference-stage data.
...
available on the internet. Vijil's tests are intended to probe for such memorization capabilities. For this, Vijil supplies an agent
with
