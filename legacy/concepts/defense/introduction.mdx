...
<img src="/images/defense-flow.svg" alt="Defense flow: Input through Guardrail, Guards, Detectors, then to Agent, then Output through Detectors, Guards, Guardrail" style={{maxWidth: '600px', margin: '2rem auto', display: 'block'}} />
