...
<Frame>
  <img src="/images/legacy/quickstart-agent-registry.png" alt="Agent Registry showing registered agents with status and Trust Score" />
</Frame>

Click **+ Register Agent** to open the registration modal.

<Frame>
  <img src="/images/legacy/quickstart-register-agent-new.png" alt="Register Agent modal with Black Box, Grey Box, and White Box options" />
</Frame>
...
<Frame>
  <img src="/images/legacy/quickstart-create-harness-new.png" alt="Create Harness wizard showing the four-step configuration flow" />
</Frame>
...
<Frame>
  <img src="/images/legacy/quickstart-custom-harness.png" alt="Custom harness detail showing agent, personas, and policies" />
</Frame>
<Frame>
  <img src="/images/legacy/quickstart-harness-testcases.png" alt="Generated test cases showing persona conversations and Trust Coverage scores" />
</Frame>
...
<Frame>
  <img src="/images/legacy/quickstart-evaluations.png" alt="Diamond Evaluations page showing agent selection and Trust Score dimensions" />
</Frame>
...
<Frame>
  <img src="/images/legacy/quickstart-evaluation-report.png" alt="Trust Report showing agent evaluation results with Trust Score" />
</Frame>
...
<Frame>
  <img src="/images/legacy/quickstart-dome-dashboard.png" alt="Dome Guardrails dashboard showing agent protection status" />
</Frame>

Agents show either **Domed** (protected) or **Unprotected**. Click **Configure Guardrails** to open the Dome configuration.

<Frame>
  <img src="/images/legacy/quickstart-dome-config.png" alt="Dome configuration showing input and output guards" />
</Frame>
...
<Frame>
  <img src="/images/legacy/quickstart-execution-flow.png" alt="Execution Flow showing a test prompt flowing through Security, Moderation, and Privacy guards" />
</Frame>
