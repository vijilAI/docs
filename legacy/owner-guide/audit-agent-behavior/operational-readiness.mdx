...
<Frame>
  <img src="/images/legacy/owner-guide/audit-agent-behavior/operational-readiness/sign-off-process.svg" alt="Sign-off process flow: Evaluation Complete to Gate Check to Decision, then Pass leads to Deploy, Fail leads to Remediate or Conditional deployment with re-evaluation loop" />
</Frame>
