...
<Frame>
  <img src="/images/legacy/agent-registry.png" alt="Agent Registry showing registered agents with status, access level, and Trust Score" />
</Frame>
...
<Frame>
  <img src="/images/legacy/register-agent-blackbox.png" alt="Register Agent modal showing Black Box configuration" />
</Frame>
...
<Frame>
  <img src="/images/legacy/register-agent-greybox.png" alt="Grey Box configuration showing model and external resource settings" />
</Frame>
...
<Frame>
  <img src="/images/legacy/register-agent-whitebox.png" alt="White Box configuration showing source code and GitHub repository settings" />
</Frame>
...
<Frame>
  <img src="/images/legacy/agent-actions-menu.png" alt="Agent actions menu showing Edit, Clone, Export JSON, Archive, and Delete options" />
</Frame>
...
<Frame>
  <img src="/images/legacy/edit-agent-modal.png" alt="Edit Agent modal showing populated configuration fields" />
</Frame>
