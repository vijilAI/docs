...
<Frame>
  <img src="/images/legacy/dome-guardrails-page.png" alt="Dome Guardrails page showing registered agents with status, defend, configure, and monitor columns" />
</Frame>
...
<Frame>
  <img src="/images/legacy/dome-configuration.png" alt="Dome Configuration page showing input guards, output guards, and execution flow" />
</Frame>
...
<Frame>
  <img src="/images/legacy/dome-guard-types.png" alt="Guard type dropdown showing Security, Moderation, and Privacy options" />
</Frame>
...
<Frame>
  <img src="/images/legacy/dome-input-flow.png" alt="Input flow showing security-guard and moderation-guard with their detectors processing incoming requests" />
</Frame>
...
<Frame>
  <img src="/images/legacy/dome-output-flow.png" alt="Output flow showing privacy-guard with privacy-presidio detector processing outgoing responses" />
</Frame>
