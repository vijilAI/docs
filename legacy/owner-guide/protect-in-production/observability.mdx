...
<Frame>
  <img src="/images/legacy/dome-telemetry-dashboard.webp" alt="Dome Telemetry Dashboard showing Guardrail metrics, charts, and execution traces" />
</Frame>
...
<CardGroup cols={2}>
  ...
  <Card title="Configuring Guardrails" icon="sliders" href="/owner-guide/protect-in-production/configuring-guardrails">
    ...
    <Card title="Dome SDK" icon="code" href="/legacy/protect-agents/introduction">
