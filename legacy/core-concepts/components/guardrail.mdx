...
{/* vale off */}
![Guardrail-position | 80%](/images/legacy/guardrails_workflow.webp)
{/* vale off */}

Guardrails consist of a set of [Guards](/legacy/core-concepts/components/guard) and how they should be executed. These Guards are fully configurable and customizable.
