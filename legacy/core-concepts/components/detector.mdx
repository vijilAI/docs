...
[Detectors](/legacy/core-concepts/components/detector) are the components within Guards that perform the actual detection of issues. Each [Guard](/legacy/core-concepts/components/guard) can include multiple Detectors, each responsible for identifying specific types of risks or violations.
