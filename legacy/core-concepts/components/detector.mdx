...
[Detectors](/core-concepts/components/detector) are the components within Guards that perform the actual detection of issues. Each [Guard](/core-concepts/defense/guard) can include multiple Detectors, each responsible for identifying specific types of risks or violations.
