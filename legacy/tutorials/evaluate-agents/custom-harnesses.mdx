...
![Harness metadata](/images/legacy/harness_meta.png)

<Tabs>
    <Tab title="Select Prompts">
        1. Select an existing prompt, or create a new one by pressing **Add Prompt**.
        ![Prompt selection](/images/legacy/select_prompts.png)
        2. Press Create.
    </Tab>
    <Tab title="Generate Prompts">
        ...
        ![Specify an Agent](/images/legacy/specify_agent.png)
        2. Specify up to 3 **Personas**.
       ![Specify a Persona](/images/legacy/specify_personas.png) 
        <Info>
        ...
        ![Specify Policy Requirements](/images/legacy/policy_requirements.png) 
        <Info>
        ...
        ![Specify Additional Tests](/images/legacy/specify_additional_tests.png)
        5. Press Create.
    </Tab>
</Tabs>
