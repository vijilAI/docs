...
![Agent selection in an Evaluation](/images/legacy/select_agents.webp)
3. In the **Select Harness** section, you can configure:
    ...
    - **Custom** - Select your custom [Harness](/legacy/core-concepts/components/harness).
    - **Benchmarks** - Select specific benchmarks from the Trust Scores.
    - **Garak** - Select Garak Scenarios.
![Harness selection in an Evaluation](/images/legacy/select_harness.webp)
...
![Selected Agents shown](/images/legacy/selected_agents.webp)
5. Enter an Evaluation name in the `Enter a name...` field.
![Evaluation name entry](/images/legacy/evaluation_name.webp)
6. Press Create.
...
![API Token Location | 80%](/images/legacy/token-generation.webp)
