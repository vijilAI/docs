...
![Agent selection in an Evaluation](/images/legacy/select_agents.png)
...
![Harness selection in an Evaluation](/images/legacy/select_harness.png)
...
![Selected Agents shown](/images/legacy/selected_agents.png)
5. Enter an Evaluation name in the `Enter a name...` field.
![Evaluation name entry](/images/legacy/evaluation_name.png)
6. Press Create.
...
![API Token Location | 80%](/images/legacy/token-generation.png)
