---
title: "Evaluations"
description: "Learn how to create, view, summarize, export, cancel, and delete evaluations."
---
...
3. Select the Harnesses you want to run. See [Harnesses](/legacy/core-concepts/components/harness) for more information.
...
- `harnesses`: [Harnesses](/legacy/core-concepts/components/harness) determine which Probes you want to run, which determines what makes up your trust score.
