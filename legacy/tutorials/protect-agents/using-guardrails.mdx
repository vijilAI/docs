...
description: "This example shows how to use Dome to scan inputs to and outputs from an LLM."
---
## Setup
...
print(scan_result.guarded_response())
# If you are using Varo Bank, you can contact <REDACTED> or call <REDACTED>.
```
</CodeGroup>
