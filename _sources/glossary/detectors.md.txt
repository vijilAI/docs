...
This maps detector module names you may see in your [reports](../evaluate/examples/evaluations.md#export-prompt-level-details) to the [actual detector names](../components/detectors.md) and descriptions.
