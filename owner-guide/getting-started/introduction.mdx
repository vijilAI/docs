...
<Steps>
  ...
  <Step title="Run an Evaluation">
    ...
    Open **Verify** in the **Console**. Pick the **Agent** and a [Harness](/concepts/evaluation-components/harness):
  ...
  <Step title="Run Red Team">
    ...
    1. Open **Verify** in the **Console** and click **Create Evaluation**. 
