...
This page explains how Vijil helps both sides, then walks through the **Console**: register an Agent, run an Evaluation, optionally run [Red Team](/owner-guide/red-team/running-campaigns), read your [Trust Report](#read-the-trust-report), and configure **[Dome](/concepts/welcome#build-ship-run-evolve)** Guardrails.
...
<Steps>
  ...
  <Step title="Custom Harness">

    <Badge color="gray">Optional Step.</Badge>
     ...
     Set the **[Harness](/concepts/evaluation-components/harness)** to **<Badge color="green">ACTIVE</Badge>** when you are ready.
  </Step>
  ...
  <Step title="Run Red Team">
    <Badge color="gray">Optional Step.</Badge>

    <Info>
      [Red Team](/concepts/red-team/introduction) is Diamond's adaptive adversarial evaluation mode for uncovering vulnerabilities, policy violations, leaked artifacts, and successful attack strategies.
    </Info>
    ...
    3. In the **Test Configuration** panel select the **Adaptive** tab.
    4. Configure the Red Team settings.
    5. Start the run.

    See [Run a Red Team Campaign](/owner-guide/red-team/running-campaigns) for every setting and its tradeoff, and [Understand Red Team Results](/owner-guide/red-team/understanding-results) for reading what comes back.

    <Tip>Start with a small campaign, then increase waves, seeds, and parallel attackers when you understand cost and runtime for your Agent.</Tip>
  </Step>
...
<Card title="MCP Quickstart" icon="plug" href="/developer-guide/agentic/quickstart">
