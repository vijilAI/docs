...
<Frame>
  <img src="/images/owner-guide/getting-started/quick-start/quickstart-agent-registry.png" alt="Agent Registry showing registered agents with status and Trust Score" />
</Frame>

<Frame>
  <img src="/images/owner-guide/getting-started/quick-start/quickstart-register-agent-new.png" alt="Register Agent modal with Black Box, Grey Box, and White Box options" />
</Frame>
...
<Frame>
  <img src="/images/owner-guide/getting-started/quick-start/quickstart-create-harness-new.png" alt="Create Harness wizard showing the four-step configuration flow" />
</Frame>
...
<Frame>
  <img src="/images/owner-guide/getting-started/quick-start/quickstart-evaluations.png" alt="Diamond Evaluations page showing agent selection and Trust Score dimensions" />
</Frame>
...
<Frame>
  <img src="/images/owner-guide/getting-started/quick-start/quickstart-evaluation-report.png" alt="Trust Report showing agent evaluation results with Trust Score" />
</Frame>
...
<Frame>
  <img src="/images/owner-guide/getting-started/quick-start/quickstart-dome-dashboard.png" alt="Dome Guardrails dashboard showing agent protection status" />
</Frame>

<Frame>
  <img src="/images/owner-guide/getting-started/quick-start/quickstart-dome-config.png" alt="Dome configuration showing input and output guards" />
</Frame>

<Frame>
  <img src="/images/owner-guide/getting-started/quick-start/quickstart-execution-flow.png" alt="Execution Flow showing a test prompt flowing through Security, Moderation, and Privacy guards" />
</Frame>

Save when the pipeline matches your policy. Ongoing monitoring: [Observability](/owner-guide/protect-in-production/observability).
...
Details: [Installation](/developer-guide/getting-started/installation) and [Configuring guardrails](/owner-guide/protect-in-production/configuring-guardrails).
...
<CardGroup cols={2}>
  ...
  <Card title="Understand results" icon="chart-line" href="/owner-guide/run-evaluations/understanding-results">
    Reports and stakeholder evidence
  </Card>
  <Card title="Enterprise deployment" icon="building" href="/owner-guide/getting-started/enterprise-deployment">
