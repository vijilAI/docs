...
<CardGroup cols={2}>
  ...
  <Card title="Set Policies" icon="scroll-text" href="/owner-guide/simulate-environment/policies">
  ...
  <Card title="Generate Trust Reports" icon="file-text" href="/owner-guide/run-evaluations/understanding-results">
