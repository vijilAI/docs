...
<Frame>
  <img src="/images/owner-guide/run-evaluations/running-evaluations/diamond-evaluations-page.png" alt="Diamond Evaluations page showing agent selection, harness configuration, and evaluation results" />
</Frame>
