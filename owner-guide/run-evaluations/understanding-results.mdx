...
<Note>
Red Team campaigns produce campaign evidence rather than a Trust Score, and their results page reads differently. See [Understand Red Team Results](/owner-guide/red-team/understanding-results) for waves, attacker transcripts, judgments, and the final report.
</Note>
...
<CardGroup cols={2}>
  ...
  <Card title="Red Team Results" icon="crosshair" href="/owner-guide/red-team/understanding-results">
    Read waves, judgments, and campaign reports
  </Card>
</CardGroup>
