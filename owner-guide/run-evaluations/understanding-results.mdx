...
Red Team results are campaign evidence, not a Trust Score. Open a Red Team result from **Verify** → **Evaluation Results** by selecting an evaluation with type **Red Team**.
