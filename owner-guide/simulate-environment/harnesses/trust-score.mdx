...
<Frame>
  <img
    src="/images/owner-guide/simulate-environment/harnesses/trust-score/evaluations-trust-score.webp"
    alt="Diamond Evaluations page showing agent selection and Trust Score dimensions"
  />
</Frame>
...
<Frame>
  <img
    src="/images/owner-guide/simulate-environment/harnesses/trust-score/evaluations-agent-selected.webp"
    alt="Evaluation ready to run with agent selected and Run Evaluation button enabled"
  />
</Frame>
...
<Frame>
  <img
    src="/images/owner-guide/simulate-environment/harnesses/trust-score/trust-report.webp"
    alt="Trust Report showing agent name, pass/fail status, and Trust Score"
  />
</Frame>
...
<CardGroup cols={2}>
  <Card
    title="Build Custom Harnesses"
    icon="ruler"
    href="/owner-guide/simulate-environment/custom-harnesses"
  >
  ...
  <Card
    ...
    icon="brain"
    href="/owner-guide/run-evaluations/understanding-results"
  >
  ...
  <Card
    ...
    href="/owner-guide/protect-in-production/configuring-guardrails"
  >
