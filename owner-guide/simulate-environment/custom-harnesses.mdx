...
Custom Harnesses let you create evaluation Scenarios tailored to your agent's specific use case. By combining an agent with selected [personas](#) and [policies](/owner-guide/simulate-environment/policies), you generate test cases that [Probe](/concepts/evaluation-components/probe) exactly the behaviors that matter to your organization.
...
<Note>
Only agents with status **Active** appear in the selection list. Register and activate your agent first if it does not appear.
</Note>
