...
<Frame>
  <img src="/images/owner-guide/audit-agent-behavior/quantifying-risk/treemap-of-trust.webp" alt="Treemap of Trust showing hierarchical risk visualization with color-coded categories" />
</Frame>
...
<CardGroup cols={2}>
  ...
  <Card title="Understand Results" icon="list-check" href="/owner-guide/run-evaluations/understanding-results">
