...
| **Automated Evaluation** | Uses [Probes](/concepts/evaluation-components/probe) across [Scenarios](/concepts/evaluation-components/scenario) for a Trust Score, or adaptive [Red Team](/concepts/platform/diamond#red-team-in-diamond) attacks for deeper exploration | Requires Agent registration; only behavioral evaluations use a [Harness](/concepts/evaluation-components/harness) |

Choose a behavioral evaluation for a measurable [Trust Score](/concepts/trust-score/introduction) or a Red Team evaluation for findings about harder-to-detect vulnerabilities and successful attack strategies.
