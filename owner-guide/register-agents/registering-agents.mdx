...
<Frame>
  <img src="/images/owner-guide/register-agents/registering-agents/agent-registry.webp" alt="Agent Registry showing registered agents with status, access level, and Trust Score" />
</Frame>
...
<Frame>
  <img src="/images/owner-guide/register-agents/registering-agents/register-agent-blackbox.webp" alt="Register Agent modal showing Black Box configuration" />
</Frame>
...
<Frame>
  <img src="/images/owner-guide/register-agents/registering-agents/register-agent-greybox.webp" alt="Grey Box configuration showing model and external resource settings" />
</Frame>
...
<Frame>
  <img src="/images/owner-guide/register-agents/registering-agents/register-agent-whitebox.webp" alt="White Box configuration showing source code and GitHub repository settings" />
</Frame>
...
<Frame>
  <img src="/images/owner-guide/register-agents/registering-agents/agent-actions-menu.webp" alt="Agent actions menu showing Edit, Clone, Export JSON, Archive, and Delete options" />
</Frame>
...
<Frame>
  <img src="/images/owner-guide/register-agents/registering-agents/edit-agent-modal.webp" alt="Edit Agent modal showing populated configuration fields" />
</Frame>
