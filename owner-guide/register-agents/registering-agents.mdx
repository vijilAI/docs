...
For provider-specific configuration details, see the [Cloud Providers guide](/manage-agents/integrations/platform) in the Developer Guide.

<CardGroup cols={2}>
  <Card title="Cloud Providers" icon="cloud" href="/manage-agents/integrations/platform">
    OpenAI, Anthropic, Bedrock, Vertex, and more
  </Card>
  <Card title="Custom Agents" icon="code" href="/manage-agents/integrations/custom">
