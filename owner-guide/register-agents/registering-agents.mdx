...
<CardGroup cols={3}>
  <Card title="OpenAI" icon="loader-pinwheel" href="/owner-guide/register-agents/integrations/openai" />
  <Card title="Anthropic" icon="triangle" href="/owner-guide/register-agents/integrations/anthropic" />
  <Card title="Google Vertex" icon="google" iconType="brands" href="/owner-guide/register-agents/integrations/vertex" />
  <Card title="Mistral AI" icon="wind" href="/owner-guide/register-agents/integrations/mistral" />
  <Card title="AWS Bedrock" icon="aws" iconType="brands" href="/owner-guide/register-agents/integrations/bedrock" />
  <Card title="DigitalOcean" icon="digital-ocean" iconType="brands" href="/owner-guide/register-agents/integrations/digitalocean" />
  <Card title="Groq" icon="zap" href="/owner-guide/register-agents/integrations/groq" />
  <Card title="Together AI" icon="layers" href="/owner-guide/register-agents/integrations/together" />
  ...
  <Card title="NVIDIA NIM" icon="cpu" iconType="brands" href="/owner-guide/register-agents/integrations/nvidia" />
