...
<Tip>
If you do not know what to register yet, [Discover](/concepts/platform/discover) finds the Agents running in your estate and registers the eligible ones in one action. See [Register a Discovered Agent](/owner-guide/discover/registering-agents).
</Tip>
