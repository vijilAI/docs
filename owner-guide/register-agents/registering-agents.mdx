...
<Frame>
  <img src="/images/owner-guide/register-agents/registering-agents/agent-registry.png" alt="Agent Registry showing registered agents with status, access level, and Trust Score" />
</Frame>
...
<Frame>
  <img src="/images/owner-guide/register-agents/registering-agents/register-agent-blackbox.png" alt="Register Agent modal showing Black Box configuration" />
</Frame>
...
<Frame>
  <img src="/images/owner-guide/register-agents/registering-agents/register-agent-greybox.png" alt="Grey Box configuration showing model and external resource settings" />
</Frame>
...
| [Google Cloud (Agentforce)](/owner-guide/register-agents/integrations/agentforce) | `agentforce` | Agentforce-hosted agents (via Agentforce configuration) | 30 requests / 60s |
| [Azure](/owner-guide/register-agents/integrations/azure) | `azure` | Azure-hosted deployments (models configured in your Azure account) | 60 requests / 60s |
...
<Frame>
  <img src="/images/owner-guide/register-agents/registering-agents/register-agent-whitebox.png" alt="White Box configuration showing source code and GitHub repository settings" />
</Frame>
...
<Frame>
  <img src="/images/owner-guide/register-agents/registering-agents/agent-actions-menu.png" alt="Agent actions menu showing Edit, Clone, Export JSON, Archive, and Delete options" />
</Frame>
...
<Frame>
  <img src="/images/owner-guide/register-agents/registering-agents/edit-agent-modal.png" alt="Edit Agent modal showing populated configuration fields" />
</Frame>
...
<CardGroup cols={3}>
  <Card title="OpenAI" icon="cloud" href="/owner-guide/register-agents/integrations/openai" />
  <Card title="Anthropic" icon="cloud" href="/owner-guide/register-agents/integrations/anthropic" />
  <Card title="Google Vertex" icon="cloud" href="/owner-guide/register-agents/integrations/vertex" />
  <Card title="Mistral AI" icon="cloud" href="/owner-guide/register-agents/integrations/mistral" />
  <Card title="AWS Bedrock" icon="cloud" href="/owner-guide/register-agents/integrations/bedrock" />
  <Card title="DigitalOcean" icon="cloud" href="/owner-guide/register-agents/integrations/digitalocean" />
  <Card title="Groq" icon="cloud" href="/owner-guide/register-agents/integrations/groq" />
  <Card title="Together Web" icon="cloud" href="/owner-guide/register-agents/integrations/together" />
  <Card title="OpenRouter" icon="cloud" href="/owner-guide/register-agents/integrations/openrouter" />
  <Card title="Fireworks AI" icon="cloud" href="/owner-guide/register-agents/integrations/fireworks" />
  <Card title="NVIDIA NIM" icon="cloud" href="/owner-guide/register-agents/integrations/nvidia" />
