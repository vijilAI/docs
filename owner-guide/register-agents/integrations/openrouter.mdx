...
description: "Legacy OpenRouter integration docs copied from the integrations-section branch."
---
...
![Setting up an OpenRouter-based Agent in Vjil](/images/owner-guide/register-agents/integrations/openrouter.png)
