---
title: "Mistral AI (Legacy)"
description: "Legacy Mistral AI integration docs copied from the integrations-section branch."
---
...
![Setting up a Mistral-based Agent in Vjil](/images/owner-guide/register-agents/integrations/mistral.png)
