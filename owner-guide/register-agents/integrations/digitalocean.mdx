---
title: "DigitalOcean (Legacy)"
description: "Legacy DigitalOcean integration docs copied from the integrations-section branch."
---
...
![Setting up a DigitalOcean-based Agent in Vjil](/images/owner-guide/register-agents/integrations/digitalocean.png)
