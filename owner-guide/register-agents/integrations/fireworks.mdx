---
title: "Fireworks AI (Legacy)"
description: "Legacy Fireworks AI integration docs copied from the integrations-section branch."
---
...
![Setting up a Fireworks-based Agent in Vjil](/images/owner-guide/register-agents/integrations/fireworks.png)
