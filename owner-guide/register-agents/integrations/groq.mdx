---
title: "Groq (Legacy)"
description: "Legacy Groq integration docs copied from the integrations-section branch."
---
...
![Setting up a Groq-based Agent in Vjil](/images/owner-guide/register-agents/integrations/groq.png)
