---
title: "NVIDIA NIM (Legacy)"
description: "Legacy NVIDIA NIM integration docs copied from the integrations-section branch."
---
...
![Setting up an NVIDIA-based Agent in Vjil](/images/owner-guide/register-agents/integrations/nvidia.png)
