...
<Frame>
  <img src="/images/owner-guide/protect-in-production/configuring-guardrails/dome-guardrails-page.png" alt="Dome Guardrails page showing registered agents with status, defend, configure, and monitor columns" />
</Frame>
...
<Frame>
  <img src="/images/owner-guide/protect-in-production/configuring-guardrails/dome-configuration.png" alt="Dome Configuration page showing input guards, output guards, and execution flow" />
</Frame>
...
<Frame>
  <img src="/images/owner-guide/protect-in-production/configuring-guardrails/dome-guard-types.png" alt="Guard type dropdown showing Security, Moderation, and Privacy options" />
</Frame>
...
<Frame>
  <img src="/images/owner-guide/protect-in-production/configuring-guardrails/dome-input-flow.png" alt="Input flow showing security-guard and moderation-guard with their detectors processing incoming requests" />
</Frame>
...
<Frame>
  <img src="/images/owner-guide/protect-in-production/configuring-guardrails/dome-output-flow.png" alt="Output flow showing privacy-guard with privacy-presidio detector processing outgoing responses" />
</Frame>
...
<CardGroup cols={2}>
  ...
  <Card title="Protection Overview" icon="shield-half" href="/protect-agents/introduction">
    Complete SDK reference for developers
  </Card>
  <Card title="Custom Detectors" icon="wrench" href="/tutorials/protect-agents/custom-detectors">
