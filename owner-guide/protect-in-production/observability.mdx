...
<Frame>
  <img src="/images/owner-guide/protect-in-production/observability/dome-telemetry-dashboard.png" alt="Dome Telemetry Dashboard showing guardrail metrics, charts, and execution traces" />
</Frame>
...
Export options are available through the API. See the relevant endpoint docs in the [Developer Guide](/developer-guide/api/overview).
...
<CardGroup cols={2}>
  ...
  <Card title="Configuring Guardrails" icon="sliders-horizontal" href="/owner-guide/protect-in-production/configuring-guardrails">
    Adjust guard configuration
  </Card>
    <Card title="Dome SDK" icon="code" href="/protect-agents/introduction">
